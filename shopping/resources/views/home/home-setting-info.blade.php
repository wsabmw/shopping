                ...
                <div class="yui3-u-5-6">
                    <div class="body userInfo">
                        <ul class="sui-nav nav-tabs nav-large nav-primary ">
							...
							@if($data == 0) 
								<li class="active"><a href="#one" data-toggle="tab">修改基本资料</a></li>
							@else 
                        ...
                        <div class="tab-content ">
							...
							<form id="form-msg" class="sui-form form-horizontal" action="{{ route('getSetInfo') }}" method="post">
								 {{ csrf_field() }}
									@if($data == 0 )
                                    <div class="control-group">
										<label for="inputName" class="control-label" >昵称：</label>
                                        <div class="controls">
										<input type="text" id="inputName" name="name" placeholder="昵称" value="{{ $info[0]->name }}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
										<select id="select_year2" rel="{{ $birthday[0] }}" name='select'></select>年
										<select id="select_month2" rel="{{ $birthday[1] }}" name = 'select1'></select>月
										<select id="select_day2" rel="{{ $birthday[2] }}" name= 'select2'></select>日
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div data-toggle="distpicker">
												...
												<select class="form-control" id="province1" rel="{{ $home[0] }}" name='sheng'></select>
                                                </div>
                                                <div class="form-group area">
                                                    <select class="form-control" id="city1" name='shi' rel="{{ $home[1] }}"></select>
                                                </div>
                                                <div class="form-group area">
                                                    <select class="form-control" id="district1" name='qu' rel="{{ $home[2] }}"></select>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
										...
										<div class="form-group area">
												<select class="form-control" id="" name='job'>
													<option value="{{ $info[0]->job }}">{{ $info[0]->job }}</option>
													<option value="学生">学生</option>
													<option value="设计师">设计师</option>
													<option value="企业家">企业家</option>
													<option value="操盘手">操盘手</option>
												</select>
											</div>
									</div>
									@else
									<div class="control-group">
											<label for="inputName" class="control-label" >昵称：</label>
											<div class="controls">
												<input type="text" id="inputName" name="name" placeholder="昵称">
											</div>
										</div>
										<div class="control-group">
											<label for="inputGender" class="control-label">性别：</label>
										...
										<div class="control-group">
											<label for="inputPassword" class="control-label">生日：</label>
											<div class="controls">
												<select id="select_year2" rel="1990" name='select'></select>年
												<select id="select_month2" rel="4" name = 'select1'></select>月
												<select id="select_day2" rel="3" name= 'select2'></select>日
											</div>
										</div>
