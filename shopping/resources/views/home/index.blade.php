			...
			<div class="yui3-g SortList ">
				...
				@foreach($data as $v)
					<div class="all-sort-list2">
						<div class="item bo">
								<h3><a href="">{{ $v['cft_name'] }}</a></h3>
							<div class="item-list clearfix">
								<div class="subitem">
								@foreach($v['sub_menu_level1'] as $z)
									<dl class="fore1">
										<dt><a href="">{{ $z['cft_name'] }}</a></dt>
										  <dd>
											@foreach($z['sub_menu_level2'] as $c)
										  <em><a href="/searchList?id={{ $c['id'] }}">{{ $c['cft_name'] }}</a></em>
											@endforeach
										  </dd>
									</dl>
								@endforeach
