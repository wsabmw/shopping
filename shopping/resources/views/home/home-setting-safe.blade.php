                ...
                <div class="yui3-u-5-6">
                    <div class="body userSafe">
                        <ul class="sui-nav nav-tabs nav-large nav-primary ">
                            <li class="active"><a href="#one" data-toggle="tab">修改密码</a></li>
                            {{-- <li><a href="#two" data-toggle="tab">绑定手机</a></li> --}}
                        </ul>
                        <div class="tab-content ">
                            <div id="one" class="tab-pane active">
                                <form class="sui-form form-horizontal sui-validate" id="jsForm" action="/doeditpwd" method="get">
									   	{{-- {{  csrf_field() }} --}}
                                    <div class="control-group">
                                        <label for="inputusername" class="control-label">账号：</label>
                                        <div class="controls">
                                            <input id="pwdid" class="fn-tinput" data-rule-remote="http://www.baidu.com" type="password" name="username" placeholder="输入昵称"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="fn-tinput" type="password" name="newpwd" value="" placeholder="确认新密码" required equalTo="#password">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
											...
											<input type="submit" class="sui-btn btn-primary">
                                        </div>
                                    </div>
                                </form>
                            </div>
